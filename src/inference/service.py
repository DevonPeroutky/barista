...
from src.inference.constants import DEFAULT_IMAGE_PATCH_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN, \
    IGNORE_INDEX, IMAGE_TOKEN_INDEX
from src.inference.multimodal_encoder.builder import build_vision_tower
from src.inference.multimodal_projector.builder import build_vision_projector
...
class InferenceService:
    ...
    # Load model based on parameters based to InferenceService
    model = None
    tokenizer = None
    ...
    def load_pretrained_model(self, model_path: str, **kwargs):
        ...
        model = LlavaLlamaForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True, torch_dtype=torch.float16, **kwargs)
